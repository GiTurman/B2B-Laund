...
const App: React.FC = () => {
  ...
  return (
    <div className="flex h-screen min-h-screen w-full overflow-hidden bg-slate-50 text-slate-900 selection:bg-indigo-100 selection:text-indigo-800 font-sans">
      ...
      <div className="flex flex-col flex-1 min-w-0 bg-slate-50">
        ...
        <div className="flex flex-1 overflow-hidden relative">
          <main className={`flex-1 p-8 overflow-y-auto bg-slate-50 transition-all duration-300 ${aiExpanded ? 'mr-0' : 'mr-0'}`}>
            <ViewRenderer 
